...
#fixing the NNdMeasure to the mean, with standard deviation of 0.
fixedNNd<-numeric(328)
fixedNNd<-fixedNNd+mean(obsNNd)
oNNdMeasure=numeric(numMeasures)
oNNdMeasure[1] <- mean(obsNNd)
oNNdMeasure[2] <- 0.0
oNNdMeasure[3:9] <- quantile(fixedNNd,seq(0.125,0.875,length=7))
