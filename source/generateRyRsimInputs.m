...
close all
%% INPUTS
ImageDir = ['../input-files/target-tomo-cell/'];
outDir = ['../input-files/target-tomo-cell/'];
...
%% PROGRAM EXECUTION
mffile = [ImageDir myofibril_file];
...
slfile = [ImageDir sarcolemma_file];
